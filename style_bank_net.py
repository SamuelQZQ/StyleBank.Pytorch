...
class TransformerNet(torch.nn.Module):
    def __init__(self):
        ...
        # StyleBank
        self.stylebank0 = ConvLayer(128, 128, kernel_size=3, stride=1)
        self.stylebank1 = ConvLayer(128, 128, kernel_size=3, stride=1)

        # self.stylebank = []
        # for i in range(4):
        #     self.stylebank.append(ConvLayer(128, 128, kernel_size=3, stride=1))

    def forward(self, X, style_num, style_mode):
        in_X = X
